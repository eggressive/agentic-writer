...
class ImageAgent:
    ...
    def generate_image_queries(self, topic: str, article_content: str) -> List[str]:
        ...
        prompt = ChatPromptTemplate.from_messages(
            [
                SystemMessage(content=IMAGE_QUERIES_SYSTEM_PROMPT),
                HumanMessage(
    ...
    def generate_image_suggestions(self, topic: str, article_content: str) -> List[str]:
        ...
        prompt = ChatPromptTemplate.from_messages(
            [
                SystemMessage(content=IMAGE_SUGGESTIONS_SYSTEM_PROMPT),
                HumanMessage(
    ...
    def assign_image_placements(
        ...
        prompt = ChatPromptTemplate.from_messages(
            [
                SystemMessage(content=IMAGE_PLACEMENT_SYSTEM_PROMPT),
                HumanMessage(
                    content=(
