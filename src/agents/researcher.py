...
class ResearchAgent:
    ...
    def analyze_topic(self, topic: str) -> Dict[str, Any]:
        ...
        prompt = ChatPromptTemplate.from_messages([
            SystemMessage(content="""You are a research assistant. Given a topic, analyze it and:
...
Return your analysis in a structured format."""),
    ...
    def synthesize_research(self, topic: str, search_results: List[Dict[str, Any]]) -> str:
        ...
        prompt = ChatPromptTemplate.from_messages([
            SystemMessage(content="""You are a research analyst. Synthesize the following search results into a comprehensive research summary.
Focus on:
