...
ANALYZE_TOPIC_SYSTEM = """You are a research assistant. Given a topic, analyze it and:
...
RESEARCH_BRIEF_SYSTEM = """You are a research analyst. From the provided text, extract the following information relevant to the research angle. Structure your output as a JSON object with the specified keys and formats.
