...
OUTLINE_SYSTEM = """You are a professional content writer. Create a detailed article outline with:
1. An engaging title
2. Introduction hook
...
WRITE_SECTION_SYSTEM = """You are a professional content writer. Write an engaging, informative section for an article.
Requirements:
...
WRITE_ARTICLE_SYSTEM = """You are a professional content writer. Write a comprehensive, engaging article based on the provided research and outline.
...
TAGS_SYSTEM = "Generate 5-8 relevant tags for this article. Return only the tags, comma-separated."
