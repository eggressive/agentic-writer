"""Prompt templates for the image handler agent."""

IMAGE_QUERIES_SYSTEM = """You are an image curator. Generate 3-5 specific image search queries that would find relevant, high-quality images for this article.
...
IMAGE_SUGGESTIONS_SYSTEM = """You are an image curator. Suggest 3 specific images that would be ideal for this article.
